...
content = '''from aiogram.types import ReplyKeyboardMarkup, KeyboardButton, InlineKeyboardMarkup, InlineKeyboardButton
...
with open(os.path.join(base_dir, 'keyboards.py'), 'w', encoding='utf-8') as f:
    f.write(content)
